						...
						<div class="row">
							<div class="col-sm-6 col-md-6">
								<ul class="comaprison" id="comaprison-id">
									<li><strong>Destinations</strong><span>{{$trip_dos_dept_detail['name']}}</span></li>
									<li><strong>AGE RANGE  </strong><span>  {{$trip_dos_dept_detail['rooms'][0]['price_bands'][0]['min_age']}} to {{$trip_dos_dept_detail['rooms'][0]['price_bands'][0]['max_age']}} year olds</span></li>
			...
			<div class="col-sm-12 col-md-7"> 
				@if(isset($trip_dossier['details']))		
					<div class="section" id="highlights">
					        <h3>{{$trip_dossier['details'][0]['detail_type']['label']}}</h3>
							<p>{{$trip_dossier['details'][0]['body']}}</p>					        
					</div>
				@endif

		
					<div class="section" id="highlights">
					        <h3>{{$trip_dossier['details'][1]['detail_type']['label']}}</h3>
							<p>{{$trip_dossier['details'][1]['body']}}</p>
					</div>


			
					<div class="section" id="highlights">
					        <h3>{{$trip_dossier['details'][2]['detail_type']['label']}}</h3>
							<p>{{$trip_dossier['details'][2]['body']}}</p>
					</div>
